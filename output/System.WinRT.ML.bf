...
namespace Win32
{
	extension Win32
	{
		...
		public struct ILearningModelOperatorProviderNative : IUnknown
		{
			...
			public function HRESULT(ILearningModelOperatorProviderNative *self, IMLOperatorRegistry** ppOperatorRegistry) GetRegistry;
		}
		[CRepr]
		public struct ITensorNative : IUnknown
		{
			...
			public function HRESULT(ITensorNative *self, uint8** value, uint32* capacity) GetBuffer;
			public function HRESULT(ITensorNative *self, ID3D12Resource** result) GetD3D12Resource;
		}
		[CRepr]
		public struct ITensorStaticsNative : IUnknown
		{
			...
			public function HRESULT(ITensorStaticsNative *self, ID3D12Resource* value, int64* shape, int32 shapeCount, IUnknown** result) CreateFromD3D12Resource;
		}
		[CRepr]
		public struct ILearningModelDeviceFactoryNative : IUnknown
		{
			...
			public function HRESULT(ILearningModelDeviceFactoryNative *self, ID3D12CommandQueue* value, IUnknown** result) CreateFromD3D12CommandQueue;
		}
		[CRepr]
		public struct ILearningModelSessionOptionsNative : IUnknown
		{
			...
			public function HRESULT(ILearningModelSessionOptionsNative *self, uint32 intraOpNumThreads) SetIntraOpNumThreadsOverride;
		}
