...
namespace Win32
{
	extension Win32
	{
		...
		public struct IVssWriterImpl : IUnknown
		{
			...
			public VSS_APPLICATION_LEVEL GetCurrentLevel() mut => VT.GetCurrentLevel(ref this, .. var _);
			...
			public VSS_BACKUP_TYPE GetBackupType() mut => VT.GetBackupType(ref this, .. var _);
			public VSS_RESTORE_TYPE GetRestoreType() mut => VT.GetRestoreType(ref this, .. var _);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] void(ref IVssWriterImpl self, out VSS_APPLICATION_LEVEL @return) GetCurrentLevel;
				...
				public new function [CallingConvention(.Stdcall)] void(ref IVssWriterImpl self, out VSS_BACKUP_TYPE @return) GetBackupType;
				public new function [CallingConvention(.Stdcall)] void(ref IVssWriterImpl self, out VSS_RESTORE_TYPE @return) GetRestoreType;
