...
static
{
	...
	public struct INTERNET_CACHE_CONFIG_INFOA
	{
		...
		{
			public using _Anonymous_e__Struct Anonymous;
			public INTERNET_CACHE_CONFIG_PATH_ENTRYA[1] CachePaths_array;
			
			public INTERNET_CACHE_CONFIG_PATH_ENTRYA* CachePaths mut => &CachePaths_array[0];
	...
	public struct INTERNET_CACHE_CONFIG_INFOW
	{
		...
		{
			public using _Anonymous_e__Struct Anonymous;
			public INTERNET_CACHE_CONFIG_PATH_ENTRYW[1] CachePaths_array;
			
			public INTERNET_CACHE_CONFIG_PATH_ENTRYW* CachePaths mut => &CachePaths_array[0];
