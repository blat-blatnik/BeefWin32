...
static
{
	...
	public const int32 fdexPropCanGet = 1;
	public const int32 fdexPropCannotGet = 2;
	public const int32 fdexPropCanPut = 4;
	public const int32 fdexPropCannotPut = 8;
	public const int32 fdexPropCanPutRef = 16;
	public const int32 fdexPropCannotPutRef = 32;
	public const int32 fdexPropNoSideEffects = 64;
	public const int32 fdexPropDynamicType = 128;
	public const int32 fdexPropCanCall = 256;
	public const int32 fdexPropCannotCall = 512;
	public const int32 fdexPropCanConstruct = 1024;
	public const int32 fdexPropCannotConstruct = 2048;
	public const int32 fdexPropCanSourceEvents = 4096;
	public const int32 fdexPropCannotSourceEvents = 8192;
	...
	public struct IRecordInfo : IUnknown
	{
		...
		public struct VTable : IUnknown.VTable
		{
			...
			public new function [CallingConvention(.Stdcall)] HRESULT(ref IRecordInfo self, out BSTR pbstrName) GetName;
