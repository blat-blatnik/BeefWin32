...
static
{
	...
	public struct CLFS_MGMT_POLICY
	{
		...
		public struct _PolicyParameters_e__Union
		{
			...
			public struct _NewContainerExtension_e__Struct
			{
				...
				public char16[1] ExtensionString_array;
				
				public char16* ExtensionString mut => &ExtensionString_array[0];
			}
			[CRepr]
			public struct _NewContainerPrefix_e__Struct
			{
				public uint16 PrefixLengthInBytes;
				public char16[1] PrefixString_array;
				
				public char16* PrefixString mut => &PrefixString_array[0];
			}
			[CRepr]
	...
	public struct VOLUME_FAILOVER_SET
	{
		...
		public uint32[1] DiskNumbers_array;
		
		public uint32* DiskNumbers mut => &DiskNumbers_array[0];
	}
	[CRepr]
	...
	public struct VOLUME_PHYSICAL_OFFSETS
	{
		...
		public VOLUME_PHYSICAL_OFFSET[1] PhysicalOffset_array;
		
		public VOLUME_PHYSICAL_OFFSET* PhysicalOffset mut => &PhysicalOffset_array[0];
	}
	[CRepr]
	...
	public struct VOLUME_CRITICAL_IO
	{
		...
		public FILE_EXTENT[1] Extents_array;
		
		public FILE_EXTENT* Extents mut => &Extents_array[0];
	}
	[CRepr]
	...
	public struct WIN32_STREAM_ID
	{
		...
		public char16[1] cStreamName_array;
		
		public char16* cStreamName mut => &cStreamName_array[0];
	}
	[CRepr]
	...
	public struct FILE_STREAM_INFO
	{
		...
		public char16[1] StreamName_array;
		
		public char16* StreamName mut => &StreamName_array[0];
	}
	[CRepr]
