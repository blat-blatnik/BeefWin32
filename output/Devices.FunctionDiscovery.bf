...
static
{
	...
	public struct IFunctionInstance : IServiceProvider
	{
		...
		public HRESULT OpenPropertyStore(STGM dwStgAccess, out IPropertyStore* ppIPropertyStore) mut => VT.OpenPropertyStore(ref this, dwStgAccess, out ppIPropertyStore);
		...
		public struct VTable : IServiceProvider.VTable
		{
			...
			public new function [CallingConvention(.Stdcall)] HRESULT(ref IFunctionInstance self, STGM dwStgAccess, out IPropertyStore* ppIPropertyStore) OpenPropertyStore;
