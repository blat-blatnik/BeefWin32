...
static
{
	...
	public struct ID3D12VideoDecoderHeap : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_DECODER_HEAP_DESC GetDesc() mut => VT.GetDesc(ref this, .. var _);
	...
	public struct ID3D12VideoDecoder : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_DECODER_DESC GetDesc() mut => VT.GetDesc(ref this, .. var _);
	...
	public struct ID3D12VideoProcessor : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC GetOutputStreamDesc() mut => VT.GetOutputStreamDesc(ref this, .. var _);
	...
	public struct ID3D12VideoMotionEstimator : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_MOTION_ESTIMATOR_DESC GetDesc() mut => VT.GetDesc(ref this, .. var _);
	...
	public struct ID3D12VideoMotionVectorHeap : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC GetDesc() mut => VT.GetDesc(ref this, .. var _);
		public HRESULT GetProtectedResourceSession(in Guid riid, void** ppProtectedSession) mut => VT.GetProtectedResourceSession(ref this, riid, ppProtectedSession);
	...
	public struct ID3D12VideoExtensionCommand : ID3D12Pageable
	{
		...
		public D3D12_VIDEO_EXTENSION_COMMAND_DESC GetDesc() mut => VT.GetDesc(ref this, .. var _);
		public HRESULT GetProtectedResourceSession(in Guid riid, void** ppProtectedSession) mut => VT.GetProtectedResourceSession(ref this, riid, ppProtectedSession);
